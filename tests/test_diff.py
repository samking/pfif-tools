...
class DiffTests(unittest.TestCase):
  ...
  @staticmethod
  def xml_to_object(xml_string, ignore_fields=None):
    """Objectifies the xml_string."""
    return pfif_diff.objectify_pfif_xml(StringIO(xml_string), ignore_fields)
  ...
  def compare_reference_object(self, test_xml, reference_object,
    ...
    reference_object."""
    xml_object = self.xml_to_object(test_xml, ignore_fields)
