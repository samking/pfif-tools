...
class PfifDiffTool:
  ...
  def record_id_to_key(record_id, is_person):
    ...
    if is_person:
      return PfifDiffTool.PERSON_PREFIX + record_id
    else:
      return PfifDiffTool.NOTE_PREFIX + record_id
  ...
  def objectify_parents(parents, is_person, object_map, tree,
    ...
    for parent in parents:
      ...
      record_map = object_map.setdefault(
          PfifDiffTool.record_id_to_key(record_id, is_person), {})
      ...
      if is_person:
        PfifDiffTool.objectify_parents(
            parent.findall(tree.add_namespace_to_tag('note')),
  ...
  def objectify_pfif_xml(file_to_objectify):
    ...
    object_map = {}
    PfifDiffTool.objectify_parents(tree.get_all_persons(), True, object_map,
                                   tree)
    PfifDiffTool.objectify_parents(tree.get_top_level_notes(), False,
                                   object_map, tree)
    return object_map
